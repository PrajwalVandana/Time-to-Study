...
export var correct_char_color = "#ffffff"
export var incorrect_char_color = "#f90000"
export var untyped_color = "#808080"
...
func _ready():
	...
	for c in chars_to_type:
		$Words.bbcode_text += colored_bbcode(c, untyped_color)
